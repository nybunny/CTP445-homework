...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class PrefabImagePairManager : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        // When device camera observe trackable image, call this function
        ...
        // Create prefab for tracked image
        void AssignPrefab(ARTrackedImage trackedImage)
        {
            if (m_PrefabsDictionary.TryGetValue(trackedImage.referenceImage.guid, out var prefab))
            {
                ...
                /////// TO DO #3 [Augment prefabs to a specified location] ///////
                m_Instantiated[trackedImage.referenceImage.guid].transform.position = trackedImage.transform.position + new Vector3(trackedImage.size.x, 0.0f, 0.0f);

                //////////////////////////////////////////////////////////////////
            }
        }

        // Utilize this function for switching instantiated prefab to alternative prefabs
        public void SetPrefabForReferenceImage(XRReferenceImage referenceImage, GameObject alternativePrefab)
        {
            ...
            if (m_Instantiated.TryGetValue(referenceImage.guid, out var instantiatedPrefab))
            {
                ...
                m_Instantiated[referenceImage.guid].transform.position = instantiatedPrefab.transform.position;
