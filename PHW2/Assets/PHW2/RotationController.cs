...
{
    /// <summary>
    /// Controls the orientation of content place by the <see cref="PHW2_main"/>
    ...
    public class RotationController : MonoBehaviour
    {
        ...
        float angle
        {
            get
            {
                return m_PHW2_main.rotation.eulerAngles.y;
            }
            set
            {
                m_PHW2_main.rotation = Quaternion.AngleAxis(value, Vector3.up);
                UpdateText();
            }
        }
